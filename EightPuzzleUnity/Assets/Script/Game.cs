...
public class Game : MonoBehaviour
{
    ...
    [SerializeField] private GameObject ShowBtnAStar;
    [SerializeField] private GameObject TrainBFSBtn;
    [SerializeField] private GameObject TrainAStarBtn;
    ...
    //Breadth First Search Start Training
    public void WaitingTrainBFS()
    {
    ...
    //A Star Start Training
    public void WaitingTrainAStar()
    {
        TrainingPanel.SetActive(true);
        WaitTraining.Play();
        WaitingText.SetActive(true);
        ShowBtnAStar.SetActive(false);
        Invoke("TrainAStar", 2);
    }
    public void TrainAStar()
    {
        string InitialTileList = "";
        ...
        CorrectPath = AStarSearch(InitialTileList);
        WaitTraining.Stop();
        WaitingText.SetActive(false);
        ShowBtnAStar.SetActive(true);

    }

    //swapping the empty tile and the specific number to move 
    ...
    //Get the specific number to move
